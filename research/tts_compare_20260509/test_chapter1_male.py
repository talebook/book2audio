...
def main():
    print("=" * 70)
    print("🎙️  CosyVoice 男音测试 - 《玄鉴仙族》第一章")
    print("=" * 70)
    ...
    result = cosyvoice.inference_sft(CHAPTER1_TEXT, '中文男', stream=False)

    elapsed = time.time() - start_time

    output_path = "output_chapter1_male.wav"
    torchaudio.save(output_path, result['tts_speech'], cosyvoice.sample_rate)

    audio_duration = result['tts_speech'].shape[1] / cosyvoice.sample_rate
    ...
    print(f"📊 实时因子: {audio_duration/elapsed:.2f}x")
    print(f"🎚️ 采样率: {cosyvoice.sample_rate} Hz")
