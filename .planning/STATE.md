...
| 2026-06-11 | L3 画像走纯规则（性别/年龄/称呼语），不用 LLM | 线索均为显式文本，毫秒级；LLM 对比实测 Qwen 0.6b/0.8b 在归属任务仅 50%/43% | ✅ 决定 |
| 2026-06-11 | CosyVoice3-0.5B 本地接入完成（隔离venv+子进程批处理） | Mac CPU RTF≈9.5 无 MPS；试听/量产需远程 GPU 或换真人参考音色库 | ✅ 决定 |
